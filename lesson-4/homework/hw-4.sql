...
-- 3. DISTINCT Category, ProductName, Price for products priced > 50
SELECT DISTINCT Category, ProductName, Price
FROM Products
WHERE Price > 50;


-- 4. Products where Price < 10% of AVG Price
SELECT *
FROM Products
...
-- 8. Orders placed in last 180 days using BETWEEN + LATEST_DATE
SELECT *
FROM Orders
